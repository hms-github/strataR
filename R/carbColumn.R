...
#'
#' @details Create a stratigraphic column of shallow-marine carbonates, based on a model similar to that of Read et al. (1986; Geology 14:107–110). Model includes tectonic subsidence, eustasy, and depth-dependent carbonate sedimentation rates, but not isostasy, compaction, or erosion.
#'
...
#' @export
#' 
#' @return returns an object of class `column`.
#' 
