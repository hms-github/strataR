#' @title First and Last Occurrences of Marine Species (FADs and LADs)
#'
#' @description `marineFadLad` returns the first and last occurrence of every marine species in a column.
#'
...
#'
#' @param occurrences an object of class [`marineOccurrences`].
#'
#' @export
#' 
...
#' @examples
#' data(maroccu)
#' marineFadLad(maroccu)
#'

# Used in occurrencePlot
marineFadLad <- function(occurrences) {	
