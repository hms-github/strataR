...
This second example contrasts with the previous one, showing a foreland basin, which has the characteristic thickening of sediment towards the sediment source (left). Eustatic history is identical to the previous passive-margin simulation, but sediment is four times greater. If sediment was equal to the passive-margin case, the architecture would be strongly retrogradational, owing to trapping of sediment near the sediment source.
...
Third, create a subsequent increase in sediment volume.
