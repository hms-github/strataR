...
The `symmetry` argument is used to create sine waves that vary in symmetry; a symmetrical (classical) sine wave is the default. The argument varies from 0.0, where the fall is rapid and the rise is gentle, to 1.0, where the fall is gentle and the rise is rapid. A value of 0.5 corresponds to a symmetrical sine wave.
